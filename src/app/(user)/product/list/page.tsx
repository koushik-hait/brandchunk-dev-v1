...
const plist = ["a", "b", "c", "a", "b", "c", "a", "b", "c", "a", "b"];

const ProductListPage = () => {
  return (
    <>
      <div className="mx-auto max-w-screen-lg">
        <div className="relative h-56 rounded-b-lg bg-cover bg-center bg-no-repeat shadow-lg bg-img">
        ...
        <main className="grid grid-cols-2 gap-x-6 gap-y-10 px-2 pb-20 sm:grid-cols-3 sm:px-8 lg:mt-16 lg:grid-cols-3 lg:gap-x-3 lg:px-0">
          {plist.map((p) => {
            return (
              <>
                {" "}
